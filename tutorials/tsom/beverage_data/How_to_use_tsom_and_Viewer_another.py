...
if __name__ == '__main__':
    ...
    tsom = TSOM2(X,latent_dim=2,resolution=5,SIGMA_MAX=2.0,SIGMA_MIN=0.2,TAU=50,init=init)
    tsom.fit(nb_epoch=50)
    comp=TSOM2_V(y=tsom.Y,winner1=tsom.k_star1,winner2=tsom.k_star2,label1=None,label2=beverage,button_label=situation)
    comp.draw_map()

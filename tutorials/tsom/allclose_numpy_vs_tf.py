...
from tsom_tf import TSOM2 as ts
...
class TestTSOM2(unittest.TestCase):
    def test_numpy_vs_tf(self):
        ...
        tsom_tensorflow = ts(N1=X.shape[0], N2=X.shape[1], observed_dim=2, latent_dim=2, epochs=nb_epoch, resolution=10,
                             SIGMA_MAX=2.0, SIGMA_MIN=0.2, TAU=50, init='random')

...
# What is SOM?
SOM is a type of neural network, and is a widely used algorithm for visualization and modeling of high dimensional data. It the basic algorithm has been around for a few decades, some aspects of machine learning and deep learning that showed up recently suggest new interesting improvements. Please refer to the [document](http://www.brain.kyutech.ac.jp/~furukawa/data/SOMtext.pdf) published by our laboratory for details(Japanese only).
